...
def test_division():
    ...
    en = space._encode_to_space_DiscreteSpace([-1, -1, 2])
    assert en == 1
...
@pytest.mark.parametrize(
    ...
    [
        [RLBaseTypes.NONE, None, ArrayContinuousSpace(2, -1, 3), [1.1, 1.0], [1.1, 1.0]],
        ...
        [RLBaseTypes.ARRAY_CONTINUOUS, None, ArrayContinuousSpace(2, -1, 3), [1.2, 1.0], [1.2, 1.0]],
        [RLBaseTypes.NP_ARRAY, None, NpArraySpace(2, -1, 3), np.array([1.25, 1.0], np.float32), [1.25, 1.0]],
        [RLBaseTypes.NP_ARRAY, SpaceEncodeOptions(cast=False), NpArraySpace(2, -1, 3), np.array([1.25, 1.0], np.float32), [1.25, 1.0]],
